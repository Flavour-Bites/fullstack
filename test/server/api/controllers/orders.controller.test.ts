...
vi.mock('@server/modules/orders/orders.service.js', () => ({
  ordersService: {
    findById: vi.fn(),
    restore: vi.fn(),
    findAll: vi.fn(),
...
vi.mock('@server/platform/middleware/asyncHandler.js', () => ({
...
import { ordersController } from '@server/api/controllers/orders.controller.js';
